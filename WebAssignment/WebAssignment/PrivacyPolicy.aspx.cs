...
namespace WebAssignment
{
    public partial class PrivacyPolicy : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            meta.Content = "Privacy Policy Page - Outlined below is Dot Net Football Clubs Privacy Policy.";
            MetaPlaceHolder.Controls.Add(meta);

            HtmlMeta meta2 = new HtmlMeta();
            meta2.Name = "keywords";
            meta2.Content = "Privacy Policy Page, SiteMap, Dot Net Football Club, HTML, CSS, XML, JavaScript.";
