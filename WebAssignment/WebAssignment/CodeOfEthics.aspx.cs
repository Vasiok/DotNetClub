...
{
    public partial class CodeOfEthics : System.Web.UI.Page
    {
        // user access level
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            meta.Content = "Code of Ethics Page - Dot Net Football Code of Ethics.";
            MetaPlaceHolder.Controls.Add(meta);

            HtmlMeta meta2 = new HtmlMeta();
            meta2.Name = "keywords";
            meta2.Content = "Code of Ethics Page, Dot Net Football Club, HTML, CSS, XML, JavaScript.";
